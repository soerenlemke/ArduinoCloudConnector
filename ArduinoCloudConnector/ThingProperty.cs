    ...
    string variableName)
{
    ...
    public object LastValue { get; set; } = lastValue;

    [JsonProperty("linked_to_trigger")]
    public bool LinkedToTrigger { get; set; } = linkedToTrigger;
    ...
    public string ThingId { get; set; } = thingId;

    [JsonProperty("thing_name")]
    public string ThingName { get; set; } = thingName;

    [JsonProperty("type")]
    public string Type { get; set; } = type;

    [JsonProperty("update_parameter")]
    public int UpdateParameter { get; set; } = updateParameter;

    [JsonProperty("update_strategy")]
    public string UpdateStrategy { get; set; } = updateStrategy;

    [JsonProperty("updated_at")]
    public DateTime UpdatedAt { get; set; } = updatedAt;

    [JsonProperty("value_updated_at")]
    public DateTime ValueUpdatedAt { get; set; } = valueUpdatedAt;
...
public class ThingPropertiesResponse(List<ThingProperty> properties)
{
    ...
    public List<ThingProperty> Properties { get; set; } = properties;
}