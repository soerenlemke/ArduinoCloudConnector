    ...
    private async Task HandleUnsuccessfulResponseAsync(HttpResponseMessage response, string? thingId = null)
{
    ...
    switch (response.StatusCode)
    {
        ...
        case HttpStatusCode.Unauthorized:
            logger.LogError("Unauthorized. Authentication is required and has failed or has not yet been provided.");
        ...
        case HttpStatusCode.Conflict:
            logger.LogError("Conflict. The request could not be completed due to a conflict with the current state of the resource.");
        ...
        case HttpStatusCode.UnsupportedMediaType:
            logger.LogError("Unsupported Media Type. The request entity has a media type which the server or resource does not support.");
